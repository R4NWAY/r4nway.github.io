...
<div id="cmtx_form_container" class="cmtx_form_container cmtx_clear">
    <h3 class="nk-title h4">{{ lang_heading_form }}</h3>
                ...
                @if enabled_name
                    <div class="cmtx_col_{{ user_column_size }}">
                        <div class="cmtx_container cmtx_name_container">
                            <input type="text" name="cmtx_name" id="cmtx_name" class="form-control required {{ name_symbol }}" value="{{ name }}" placeholder="{{ lang_placeholder_name }}" title="{{ lang_title_name }}" maxlength="{{ maximum_name }}" {{ name_readonly }}>
                        </div>
                    </div>
                @endif
                ...
                @if enabled_email
                    <div class="cmtx_col_{{ user_column_size }}">
                        <div class="cmtx_container cmtx_email_container">
                            <input type="email" name="cmtx_email" id="cmtx_email" class="form-control required {{ email_symbol }}" value="{{ email }}" placeholder="{{ lang_placeholder_email }}" title="{{ lang_title_email }}" maxlength="{{ maximum_email }}" {{ email_readonly }}>
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="cmtx_row cmtx_comment_row cmtx_clear">
                <div class="cmtx_col_12">
                    <div class="cmtx_container cmtx_comment_container">
                        <textarea name="cmtx_comment" class="form-control required {{ comment_symbol }}" placeholder="{{ lang_placeholder_comment }}" title="{{ lang_title_comment }}" maxlength="{{ comment_maximum_characters }}">{{ comment }}</textarea>
                    </div>
                </div>
            </div>
