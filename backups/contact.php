...
<body>
  ...
  <div class="nk-main">
    <div class="nk-header-title nk-header-title-xl">
      <div class="bg-image">
        <img class="jarallax-img" src="/assets/img/contact-test.jpg" alt="">
      </div>
          ...
          <div class="container-fluid container">
            <div class="row">
              ...
              <div class="col-xl-10 col-lg-8">
                <h3 class="nk-title-back" style="opacity: 0.5;">Contact</h3>
                <h2 class="nk-title h1">First step</h2>

              </div>
                <div class="col-xl-7 col-lg-8 col-md-7">
                <h2 class="nk-title h1">You are only one step away from a totally different life.</h2>
                <script>document.title = "Unfear | Contact"</script>
            </div>
              </div>
            </div>
          </div>
    ...
    <div class="nk-breadcrumbs text-right text-white">
      <div class="container-fluid container">
                <ul>
                    <li><a href="/">Home</a></li>
  ...
  <div class="row">
          ...
          <div class="calendly-inline-widget" data-url="https://calendly.com/unfear/30min" style="min-width:100%;height:710px;"></div>
    ...
    <div class="col">
                ...
                <div class="nk-box-2 bg-white" style="max-width: 800px;">
                        <h2 class="nk-title">Contact me directly</h2>
                        <p>If you have a question regarding your specific issue, I am happy to answer.</p>
                        <?php $path = $_SERVER['DOCUMENT_ROOT']; $path .= "/includes/contact-form.html"; include_once($path); ?>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <li>
                  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Draco Mom.</p>
                  ...
                  <li>
                  <p><strong>Website</strong> refers to Draco Mom, accessible from <a href="draco.mom" rel="external nofollow noopener" target="_blank">draco.mom</a></p>
                  </li>
                  <li>
                  ...
                  <ul>
                  <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="452421282c2b05213724262a6b282a28">[email&#160;protected]</a></li>
                  </ul><script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"si":10,"version":"2021.4.0","rayId":"63c66fa3dc013b52"}'></script>
                </div>
            </div>
        </div>
    </div>
